...
ace_advanced_ballistics_disabledInFullAutoMode = false;
ace_advanced_ballistics_simulateForGroupMembers = true;
ace_advanced_ballistics_simulateForSnipers = true;
ace_advanced_ballistics_simulationInterval = 0.05;
ace_advanced_ballistics_simulationRadius = 2000;
...
ace_repair_repairDamageThreshold_Engineer = 0.3;