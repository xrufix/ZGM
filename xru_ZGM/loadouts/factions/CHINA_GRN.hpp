...
// SF CARBINES
#define RIFLE_RECON              WEAPON("arifle_CTAR_ghex_F",RCO_TN,LASERPOINTER,"muzzle_snds_58_ghex_F")
#define RIFLE_UGL_RECON          WEAPON("arifle_CTAR_gl_ghex_F",RCO_TN,LASERPOINTER,"muzzle_snds_58_ghex_F")
#define RIFLE_RECON_TAN           RIFLE_RECON
#define RIFLE_UGL_RECON_TAN		RIFLE_UGL_RECON
#define RIFLE_DIVER 		WEAPON(CARBINE,RCO,LASERPOINTER,"muzzle_snds_58_blk_F")
#define RIFLE_UGL_DIVER 	WEAPON(CARBINE_UGL,RCO,LASERPOINTER,"muzzle_snds_58_blk_F")
...
#define DMR_RECON      WEAPON("arifle_ARX_ghex_F",DMR_OPTIC,LASERPOINTER,"muzzle_snds_65_TI_ghex_F")
