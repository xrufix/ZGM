...
#define UNIFORM             ARR_2("U_I_E_Uniform_01_F","U_I_E_Uniform_01_shortsleeve_F")      // Für Zufallsauswahl
...
#define UNIFORM_CREW        ARR_1("U_I_E_Uniform_01_tanktop_F")
...
#define VEST_LIGHT      ARR_2("V_CarrierRigKBT_01_light_EAF_F","V_CarrierRigKBT_01_light_Olive_F")
...
#define CARBINE   			"arifle_MSBS65_F"
#define CARBINE_UGL			"arifle_MSBS65_GL_F"
#define CARBINE_CCO      	WEAPON(CARBINE,LASERPOINTER,"optic_ico_01_f","","")
#define CARBINE_UGL_CCO  	WEAPON(CARBINE_UGL,LASERPOINTER,"optic_ico_01_f","","")

#define MAG_CARBINE         MAG_RIFLE
#define MAG_CARBINE_TRACER  MAG_RIFLE_TRACER

// SF CARBINES
#define RIFLE_RECON         WEAPON(RIFLE,LASERPOINTER,"optic_ico_01_camo_f","muzzle_snds_h","")
#define RIFLE_UGL_RECON     WEAPON(RIFLE_UGL,LASERPOINTER,"optic_ico_01_camo_f","muzzle_snds_h","")
#define RIFLE_RECON_TAN     RIFLE_RECON
#define RIFLE_UGL_RECON_TAN RIFLE_UGL_RECON
#define RIFLE_DIVER 		WEAPON(CARBINE,LASERPOINTER,"optic_ico_01_black_f","muzzle_snds_h","")
#define RIFLE_UGL_DIVER 	WEAPON(CARBINE_UGL,LASERPOINTER,"optic_ico_01_black_f","muzzle_snds_h","")

#define MAG_RIFLE_RECON          MAG_RIFLE
#define MAG_RIFLE_RECON_TRACER   MAG_RIFLE_TRACER

// DESIGNATED MARKSMAN RIFLES & SNIPER RIFLES
#define DMR         WEAPON("arifle_MSBS65_Mark_camo_F","optic_dms",LASERPOINTER,"bipod_01_f_blk","")
#define MAG_DMR     ARR_1("30Rnd_65x39_caseless_msbs_mag")

#define DMR_RECON       WEAPON("arifle_MSBS65_Mark_camo_F","optic_dms",LASERPOINTER,"bipod_01_f_blk","muzzle_snds_65_ti_blk_f")
#define DMR_DIVER       WEAPON("arifle_MSBS65_Mark_black_F","optic_dms",LASERPOINTER,"bipod_01_f_blk","")
...
#define MAGS_AUTORIFLE      ARR_4("ACE_200Rnd_65x39_cased_Box_red",3,"ACE_200Rnd_65x39_cased_Box_tracer_red",2)
#define MAGS_AUTORIFLE_ASST ARR_4("ACE_200Rnd_65x39_cased_Box_red",2,"ACE_200Rnd_65x39_cased_Box_tracer_red",1)

#define AUTORIFLE_RECON         WEAPON("LMG_Mk200_black_F",LASERPOINTER,"optic_hamr","bipod_01_f_blk","muzzle_snds_h_mg_blk_f")
#define MAGS_AUTORIFLE_RECON    ARR_4("200Rnd_65x39_cased_Box_Red",3,"ACE_200Rnd_65x39_cased_Box_Tracer_Dim",2)
...
/* ###################### - HEADGEAR - ###################### */
// GENERAL INFANTRY
#define HELMET          ARR_2("H_HelmetHBK_headset_F","H_HelmetHBK_ear_F")

// NON-COMBAT INFANTRY
#define HELMET_BARE     ARR_1("H_HelmetHBK_F")

// SPECIAL FORCES INFANTRY
#define HELMET_SF       ARR_1("H_HelmetHBK_chops_F")
...
/* ###################### - INSIGNIA - ###################### */
#define INSIGNIA_COMMON ARR_1("EAF_5thRegiment")
