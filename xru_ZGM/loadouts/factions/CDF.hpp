...
#define RIFLE_CCO WEAPON_OLD(RIFLE,"","rhs_acc_2dpZenit","rhs_acc_dtkakm")
#define RIFLE_RCO WEAPON_OLD(RIFLE,"rhs_acc_pkas","rhs_acc_2dpZenit","rhs_acc_dtkakm")


// GRENADIER ASSAULT RIFLE
#define RIFLE_UGL    ARR_1("rhs_weap_m70b3n_pbg40")

#define RIFLE_UGL_CCO WEAPON_OLD(RIFLE_UGL,"","","rhs_acc_dtkakm")
#define RIFLE_UGL_RCO WEAPON_OLD(RIFLE_UGL,"rhs_acc_pkas","","rhs_acc_dtkakm")

#define MAG_RIFLE           ARR_1("rhssaf_30Rnd_762x39mm_M67")
#define MAG_RIFLE_TRACER    ARR_1("rhs_30Rnd_762x39mm_bakelite_tracer")
...
// CARBINE
#define CARBINE     WEAPON_OLD("rhs_weap_m92","","","rhs_acc_dtk1l")
#define CARBINE_CCO CARBINE

#define CARBINE_UGL WEAPON_OLD("rhs_weap_akms_gp25","","","rhs_acc_dtkakm")
...
// SF CARBINES
#define RIFLE_RECON         WEAPON_OLD("rhs_weap_m21a","rhs_acc_1p63","rhs_acc_perst1ik","hlc_muzzle_556NATO_KAC")
#define RIFLE_UGL_RECON     WEAPON_OLD("rhs_weap_m21a_pbg40","rhs_acc_1p63","","hlc_muzzle_556NATO_KAC")
#define RIFLE_RECON_TAN     RIFLE_RECON
#define RIFLE_UGL_RECON_TAN	RIFLE_UGL_RECON
#define RIFLE_DIVER 		WEAPON_OLD("rhs_weap_m21s","rhs_acc_1p63","rhs_acc_perst1ik","hlc_muzzle_556NATO_KAC")
...
#define DMR         WEAPON_OLD("rhs_weap_m76","rhs_acc_pso1m2","","rhs_acc_dtk1l")
#define MAG_DMR     ARR_1("rhsgref_10Rnd_792x57_m76")

#define DMR_RECON     WEAPON_OLD("rhs_weap_m76","rhs_acc_pso1m2","rhs_acc_pbs1","rhs_acc_dtk1l")
...
#define AUTORIFLE_RECON        WEAPON_OLD("hlc_rifle_rpk_75rnd","rhs_acc_1p63","","hlc_muzzle_762SUP_AK")
...
#define PISTOL_SF	    WEAPON_OLD("rhs_weap_pp2000_folded","","","")
