...
// SF CARBINES
#define RIFLE_RECON              WEAPON("arifle_CTAR_hex_F",RCO_TN,LASERPOINTER,"muzzle_snds_58_hex_F")
#define RIFLE_UGL_RECON          WEAPON("arifle_CTAR_gl_hex_F",RCO_TN,LASERPOINTER,"muzzle_snds_58_hex_F")
...
#define DMR_RECON      WEAPON("arifle_ARX_hex_F",DMR_OPTIC,LASERPOINTER,"muzzle_snds_65_TI_hex_F")
